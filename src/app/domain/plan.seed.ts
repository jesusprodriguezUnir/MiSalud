...
// Transcripción FIEL del PDF del dietista-nutricionista. Copia literal de la
// app vanilla original (legacy/public/js/plan.js): no se reescribe ni se
// reformatea el contenido — es material clínico.
//
...
const NARANJA: Item = { n: 'Naranja', c: '170 g (1 unidad pequeña)' };
const AGUA_CENA: Item = { n: 'Agua', c: '500 g (2 vasos)' };

const desayuno = (proteina: Item) => ({
  hora: '08:30',
  items: [...DESAYUNO_BASE, proteina, NARANJA],
});

export const DIETA: DiaDieta[] = [
  // ---------------------------------------------------------------- LUNES --
  {
    dia: 'Lunes',
    entrenoFuerte: true,
...
export const ENTRENO: DiaEntreno[] = [
  {
    dia: 'Lunes',
