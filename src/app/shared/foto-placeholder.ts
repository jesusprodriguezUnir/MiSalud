...
// foto de cabecera en el panel de escritorio). Muestra la imagen real si existe
// fotoUrl, o un marcador decorativo si no está disponible.
@Component({
  selector: 'app-foto-placeholder',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    @if (fotoUrl()) {
      <div class="foto-container" [class.hero]="variante() === 'hero'">
        <img [src]="fotoUrl()" [alt]="texto()" class="foto-img" />
      </div>
    } @else {
